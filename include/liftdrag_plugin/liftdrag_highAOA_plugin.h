 ...
 *
*/
#ifndef _GAZEBO_LIFT_DRAG_HIGHAOA_PLUGIN_HH_
#define _GAZEBO_LIFT_DRAG_HIGHAOA_PLUGIN_HH_
...
namespace gazebo
{
  ...
  class GAZEBO_VISIBLE LiftDragHighAOAPlugin : public ModelPlugin
  {
    /// \brief Constructor.
    public: LiftDragHighAOAPlugin();
    ...
    /// \brief Zero AOA Lift Coefficient.
    protected: double cl0;

    /// \brief Zero AOA Drag Coefficient.
    protected: double cd0;

    /// \brief Zero AOA Pitch Moment Coefficient.
    ...
    /// \brief Blending coefficient between small and hign AOA
    protected: double M;
